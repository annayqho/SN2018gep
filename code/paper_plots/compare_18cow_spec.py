...
wl_cow, flux_cow = load_spec(cow_dir + "/AT2018cow_20180621_P200_v3.ascii")
...
wl_gep, flux_gep = load_spec(gep_dir + "/%s" %gepfile)
wl_gep, flux_gep = clip_lines(wl_gep, flux_gep, 0.03154, 'P200', 1.0)

plt.plot(
        wl_cow, flux_cow/8/1E-15,
        c='grey', drawstyle='steps-mid', lw=0.5, 
        label="AT2018cow/8, $\Delta t=5.353$")
plt.plot(
