...
def plot_uv_lc():
    ...
    # Vertical lines corresponding to the UV grism spectrum
    for axis in ax:
        axis.axvline(x=6.4, c='grey', alpha=0.5, lw=2)
        axis.text(6.4, 1.2, 'S', fontsize=14, horizontalalignment='center',
